...
//import static TicketVentas.Personalizar.cajaMensaje;
import TicketVentas.Personalizar.*;
...
//        byte[]bytes=fileInputStream.getChannel();
...
class MyPrintable implements Printable {
    ...
    public int print(Graphics g, PageFormat pf, int pageIndex) {
        ...
        try {
//            img = ImageIO.read(new File("C:\\Users\\KIN\\Documents\\NetBeansProjects\\Farmacia Innova\\src\\Ticket\\encabezado2.jpg"));
            img = ImageIO.read(ClassLoader.getSystemResource("TicketVentas/logo ticket.png"));
