...
public class DatosEnviarCorreo extends javax.swing.JFrame {
   
    //public static String Username = "sistematodolonas@gmail.com";
    //public static String PassWord = "lonas123";
    
    String Mensage = "";
    String To = "";
    String Subject = "";

    public void SendMail(String asunto, String para, String msj) {
        final String Username = "sistematodolonas@gmail.com";
        final String PassWord = "lonas123";
        ...
        try {
            ...
            JOptionPane.showMessageDialog(this, "La información ha sido enviada a su correo");

        } 
        catch (MessagingException e) {
            JOptionPane.showMessageDialog(this, "No se ha podido enviar la información");
...
//    }
    ...
    public static void main(String args[]) {
        try {
            ...
            java.util.logging.Logger.getLogger(DatosEnviarCorreo.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        }

        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DatosEnviarCorreo().setVisible(true);
            }
        });
    }
