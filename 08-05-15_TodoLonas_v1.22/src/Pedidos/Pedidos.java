...
public class Pedidos extends javax.swing.JFrame {
    ...
    public Pedidos() {
        ...
        areaEspecificacionDiseno.setText("");
        areaEspecificacionTrabajo.setText("");
    ...
    private void initComponents() {
        ...
        botonQuitarEspecificacionTrabajo = new javax.swing.JButton();
        botonQuitarEspecifiacionDiseno = new javax.swing.JButton();
        ...
        cajaAnticipo.setFont(new java.awt.Font("Arial", 0, 12)); // NOI18N
        ...
        labelCredito.setForeground(new java.awt.Color(62, 64, 149));
        ...
        botonQuitarEspecificacionTrabajo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cancelarPrecioExtra.png"))); // NOI18N
        botonQuitarEspecificacionTrabajo.setText("Restar Precio");
        botonQuitarEspecificacionTrabajo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonQuitarEspecificacionTrabajoActionPerformed(evt);
            }
        });

        botonQuitarEspecifiacionDiseno.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/cancelarPrecioExtra.png"))); // NOI18N
        botonQuitarEspecifiacionDiseno.setText("Restar Precio");
        botonQuitarEspecifiacionDiseno.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                botonQuitarEspecifiacionDisenoActionPerformed(evt);
            }
        });
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(botonQuitarEspecificacionTrabajo)
                            .addComponent(botonQuitarEspecifiacionDiseno))
...
//       
    ...
    private void cajaPagoConKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cajaPagoConKeyReleased
        //VALIDAR LOS CAMPOS DE ABONO Y EFECTIVO POR SI ESTÁN VACIAS LAS CAJAS
        if (cajaAnticipo.getText().isEmpty())
            abono=0;
        else
            abono = Double.parseDouble(cajaAnticipo.getText()); 
        if (cajaPagoCon.getText().isEmpty())
            ...
            efectivo = Double.parseDouble(cajaPagoCon.getText());
        //GENERAR LA RESPUESTA PARA EL CAMBIO
        if (!cajaPagoCon.getText().isEmpty()) {
            if (abono==0) {
                efectivo = Double.parseDouble(cajaPagoCon.getText());
                cobro = abono;                
    ...
    private void cajaPagoConKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cajaPagoConKeyTyped
        ...
        if (cajaPagoCon.getText().length() >= 7) {
            evt.consume();
        }
    }//GEN-LAST:event_cajaPagoConKeyTyped

    private void botonQuitarEspecificacionTrabajoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonQuitarEspecificacionTrabajoActionPerformed
        total = Double.parseDouble(labelTotal.getText());
        precioExtra1 = Double.parseDouble(cajaEspecificacionTrabajo.getText());
        resultado = total - precioExtra1;
        labelTotal.setText("" + resultado);
        cajaEspecificacionTrabajo.setText("0");
    }//GEN-LAST:event_botonQuitarEspecificacionTrabajoActionPerformed

    private void botonQuitarEspecifiacionDisenoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_botonQuitarEspecifiacionDisenoActionPerformed
        total = Double.parseDouble(labelTotal.getText());
        precioExtra2 = Double.parseDouble(cajaEspecificacionDiseno.getText());
        resultado = total - precioExtra2;
        labelTotal.setText("" + resultado);
        cajaEspecificacionDiseno.setText("0");
    }//GEN-LAST:event_botonQuitarEspecifiacionDisenoActionPerformed
    ...
    private void cajaAnticipoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cajaAnticipoKeyTyped
        ...
        if (cajaAnticipo.getText().length() >= 7) {
            evt.consume();
        }
    ...
    private javax.swing.JButton botonQuitarEspecifiacionDiseno;
    private javax.swing.JButton botonQuitarEspecificacionTrabajo;
