...
public class GuardarPedidos {
    ...
    public static void pedidos() {
        dia= Pedidos.fechaEntrega.getJCalendar().getDate().getDate();
        mes=Pedidos.fechaEntrega.getJCalendar().getDate().getMonth() +1 ;
        anio=Pedidos.fechaEntrega.getJCalendar().getDate().getYear()+ 1900;
        
        nombreUsuario = Pedidos.labelObtenerUsuario.getText();
        fechaSistema = Pedidos.labelObtenerFecha.getText();        
        horaSistema = horaActual;
        formaPago = Pedidos.labelCredito.getText();
        ...
        anticipo = Pedidos.cajaAnticipo.getText();
    ...
    public static void detalleProductoVenta() {
        ...
        for (int i = 0; i < numeroFila; i++) {
            ...
            importe[i] = "" + Ventas.PanelVentas.tablaPedidos.getValueAt(i, 7);
