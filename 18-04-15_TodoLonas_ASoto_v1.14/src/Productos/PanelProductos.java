...
//        labelRegresarProductos.setVisible(false);
    ...
    private void initComponents() {
        ...
        comboCategoriaPro.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Gran Formato", "Vinil ", "Alta Resolución", "Offset", "Impresión Digital", "Rígidos", "Rotulación", "Papelería", "Estructuras", "Lonas", "Anuncios", "Diseño Gráfico", "Toldos", "Articulos Promocionales", "Otros" }));
        ...
        labelRegresarProductos.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
